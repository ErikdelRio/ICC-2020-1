...
/**
 * Clase que prueba el comportamiento de una ficha de ajedrez
 */
public class Prueba {
    public static void main(String[] args) {
        ...
        Pieza damaAbajo = tab.obtenerPieza(7,3);
        System.out.println("Dama abajo: "+damaAbajo.obtenerJugadasLegales());

        Pieza damaArriba = tab.obtenerPieza(0,3);
        System.out.println("Dama arriba: "+damaArriba.obtenerJugadasLegales());
    }
}
